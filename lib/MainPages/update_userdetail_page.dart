            ...
            return IconButton(
              ...
              onPressed: () async {
                ...
                if (_usernameController.text != '')
                  userModel.user.username = _usernameController.text;
                if (_bioController.text != '')
                  userModel.user.bio = _bioController.text;
                if (_image == null) {
                  ...
                  userModel.user.avatarUrl = "http://10.0.2.2:8080/images/" +
                      userModel.user.email +
                      _image.path.split("/").last;
                  //userModel.user.avatarUrl="http://112.74.169.4:8080/bebro/images/"+userModel.user.email+_image.path.split("/").last;
                  var result1 =
                      await UpLoad.upLoad(_image, userModel.user.email);
                  if (result1 == 1) {
                    var result2 =
                        await UserNet.updateUserDetail(userModel.user);
                    if (result2 == 1) {
                      popToast("信息更新成功");
                    }
                  } else {
