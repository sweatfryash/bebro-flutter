            ...
            return Column(
              children: <Widget>[
                ...
                MyListTile(
                  ...
                  leading: Text('头像', style: textDisplayDq.copyWith(
                ...
                MyListTile(
                  ...
                  leading: Text('个人主页背景', style: textDisplayDq.copyWith(
                          fontSize: ScreenUtil().setSp(44))),
                  trailing: Container(
                    width: ScreenUtil().setHeight(130),
  ...
  showPickerDate(BuildContext context,UserModel model) {
    ...
    Picker(
      cancelText: '取消',
        ...
        selectedTextStyle: textDisplayDq.copyWith(color: Theme.of(context).primaryColor),
        textStyle: TextStyle(color: Colors.grey,fontSize: ScreenUtil().setSp(48)),
        onConfirm: (Picker picker, List value) async {
                ...
                Container(
                  ...
                  child: TextField(
                    controller: controller,
                      style: textDisplayDq.copyWith(fontSize: ScreenUtil().setSp(42)),
                      maxLength: 60,
